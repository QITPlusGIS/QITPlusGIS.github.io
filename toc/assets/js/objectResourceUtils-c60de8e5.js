import{j1 as a,gp as Qe,bW as Rt,gg as Et,D as d,iD as x,fV as pe,bD as _,np as Dt,gh as he,cF as ve,cE as Ae,fB as X,g6 as Oe,de as ue,ir as Vt,iF as It,_ as Xe,cM as Se,m3 as zt,mA as Bt,fY as Ft,cB as Ze,b_ as me,b$ as Je,ii as Ie,jR as Gt,mE as kt,cz as Ut,nq as jt,nr as Wt,a5 as Ht,ns as qt,nt as Qt,nu as Ce,aC as ze,V as Xt,j9 as Ke,ay as Zt,eo as Ye,s as Jt,iL as et,nv as tt,j$ as fe,nw as Kt,g8 as Yt,cD as eo,g9 as Be,nn as Fe,iy as to}from"./index-95bf5a29.js";import{p as u,q as oo,a3 as ao,a4 as Ge,G as v,z as ro,a5 as io,H as Le,o as P,h as ot,a6 as U,y as Y,T as ee,a7 as te,D as oe,s as B,P as G,J as no,a8 as Ne,a9 as at,aa as S,U as so,F as lo,V as co,ab as ae,ac as uo,ad as mo,ae as po,af as ho,ag as vo,ah as T,ai as Pe,aj as fo,ak as go,al as rt,am as _e,an as ke,x as xo,C as To,i as it,ao as nt,f as ge,ap as st,e as lt,aq as ct,ar as dt,X as xe,b as Te,as as ut,at as yo,au as bo,I as Co,l as mt,j as wo,k as Mo,Y as $o,Z as Oo,_ as So,K as Ao,E as se,$ as Lo,av as q,w as pt,aw as ht,ax as le}from"./FloatArray-46ebcdae.js";import{c as No,x as vt,L as Po,i as ft,O as _o,E as Ro}from"./BufferView-41ba25a0.js";import{r as Eo,n as Do,u as Ue}from"./vec32-ee2bae08.js";import{l as Vo,n as Io,i as H,o as zo,j as Bo,k as Fo,u as je,t as Go,m as ko}from"./DefaultMaterial_COLOR_GAMMA-1847746b.js";import{t as we}from"./resourceUtils-ebdc7923.js";import{e as Uo}from"./byteSizeEstimations-7cf1c05d.js";import{t as jo}from"./NestedMap-1b5db22e.js";import{t as Wo}from"./requestImageUtils-7af19df5.js";import{i as b,n as F,e as re}from"./basicInterfaces-bb952591.js";import{H as Ho}from"./InterleavedLayout-e7643592.js";import{a as gt,e as xt,r as qo}from"./VertexColor.glsl-f6556d53.js";import{o as Q,W as Qo,c as Xo,A as Zo,h as Jo,l as Ko,b as Yo,_ as ea,d as ta,S as oa}from"./OrderIndependentTransparency-b8ef1857.js";import{o as aa,r as ra}from"./doublePrecisionUtils-e3c3d0d8.js";import{n as z}from"./symbolColorUtils-fe36dbea.js";import{I as We,D as He}from"./enums-b14466b3.js";function ia(e,t){const o=e.fragment;switch(o.code.add(a`struct ShadingNormalParameters {
vec3 normalView;
vec3 viewDirection;
...
color.a = 1.0;
}`);break;case b.Mask:r.code.add(a`#define discardOrAdjustAlpha(color) { if (color.a < textureAlphaCutoff) { discard; } else { color.a = 1.0; } }`);break;case b.MaskBlend:e.fragment.code.add(a`#define discardOrAdjustAlpha(color) { if (color.a < textureAlphaCutoff) { discard; } }`)}}function wt(e,t){const{vertex:o,fragment:r}=e,s=t.hasModelTransformation;if(s){const l=Ae();o.uniforms.add(new ot("model",c=>c.modelTransformation??he)),o.uniforms.add(new U("normalTransform",c=>(ve(l,c.modelTransformation??he),l)))}const i=t.hasColorTexture&&t.alphaDiscardMode!==b.Opaque;switch(t.output){case v.Depth:case v.Shadow:case v.ShadowHighlight:case v.ShadowExcludeHighlight:case v.ObjectAndLayerIdColor:Y(o,t),e.include(ee,t),e.include(te,t),e.include(oe,t),e.include(so,t),e.include(G,t),e.include(lo,t),co(e),e.varyings.add("depth","float"),i&&r.uniforms.add(new B("tex",l=>l.texture)),o.code.add(a`
          void main(void) {
            vpos = calculateVPos();
...
}`)}function ye(e){e.include(To),e.code.add(a`
