...
}`)}function F(t){t.uniforms.add(new l("screenSizePerspective",e=>f(e.screenSizePerspective)))}function P(t){t.uniforms.add(new l("screenSizePerspectiveAlignment",e=>f(e.screenSizePerspectiveAlignment||e.screenSizePerspective)))}function f(t){return u(w,t.parameters.divisor,t.parameters.offset,t.parameters.minPixelSize,t.paddingPixelsOverride)}const w=d();function N(t,e){const r=t.vertex;e.hasVerticalOffset?(C(r),e.hasScreenSizePerspective&&(t.include(g),P(r),S(t.vertex,e)),r.code.add(s`
