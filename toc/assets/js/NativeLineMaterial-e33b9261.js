import{j1 as d,iD as p,fW as ze,my as gt,mz as Re,bL as mt,_ as je,cM as kt,m3 as Ve,D as h,mA as Ot,cx as Ke,c9 as Qt,fV as H,g9 as J,cB as et,b_ as fe,ii as G,mB as Yt,mC as Zt,g8 as Jt,fY as W,b$ as ne,gx as Le,cz as Kt,jR as Ee,mD as tt,aH as St,gy as le,mE as eo,a7 as to,bD as _,j3 as oo,cE as Pt,cD as xt,de as io,iF as ro,ir as ot,kH as ao,a5 as yt,bY as bt,ij as Oe,mF as so,V as no,ip as de,mG as N,mH as it,mI as lo,gB as ye,mJ as co,mK as po,mL as uo,mM as ee}from"./index-95bf5a29.js";import{x as fo,i as ho,u as vo}from"./BufferView-41ba25a0.js";import{w as go,x as mo,y as Me,f as Oo,e as X,o as k,s as Ne,z as So,A as Ct,a as Po,g as De,B as At,i as Ue,P as He,C as Tt,D as wt,F as _t,G as g,H as ce,I as rt,J as Fe,l as Be,j as Ge,k as We,p as v,K as qe,E as L,L as xo,M as yo,O as bo,N as Co,Q as at,R as st,S as Ao,T as $t,U as To,V as wo,W as _o,X as $o,Y as zt,Z as Et,_ as Dt,$ as It,t as Rt,a0 as zo,a1 as Eo,a2 as Do}from"./FloatArray-46ebcdae.js";import{H as jt}from"./InterleavedLayout-e7643592.js";import{c as Vt,f as Io,i as Lt,t as Ro,r as jo,l as Vo,e as Mt}from"./VertexColor.glsl-f6556d53.js";import{o as Lo}from"./floatRGBA-5b6289a8.js";import{D as nt,R as te,I as Mo,E as Ie}from"./enums-b14466b3.js";import{k as No,m as Uo,q as Ho,r as Fo,v as Bo,I as Go}from"./line-579cbfc8.js";import{o as F,s as Wo,b as he,W as Xe,A as Nt,_ as ke,c as qo,h as Xo,l as ko,d as Qo,S as Yo,e as Zo}from"./OrderIndependentTransparency-b8ef1857.js";import{n as Qe}from"./basicInterfaces-bb952591.js";import{l as ue}from"./Octree-951ba625.js";const Ye=128,Ut=.5;function Ji(t,e=Ye,o=e*Ut,i=0){const r=Jo(t,e,o,i);return new go(r,{mipmap:!1,wrap:{s:nt.CLAMP_TO_EDGE,t:nt.CLAMP_TO_EDGE},width:e,height:e,components:4,noUnpackFlip:!0})}function Jo(t,e=Ye,o=e*Ut,i=0){switch(t){case"circle":default:return Ko(e,o);case"square":return ei(e,o);case"cross":return oi(e,o,i);case"x":return ii(e,o,i);case"kite":return ti(e,o);case"triangle":return ri(e,o);case"arrow":return ai(e,o)}}function Ko(t,e){const o=t/2-.5;return pe(t,Bt(o,o,e/2))}function ei(t,e){return Ht(t,e,!1)}function ti(t,e){return Ht(t,e,!0)}function oi(t,e,o=0){return Ft(t,e,!1,o)}function ii(t,e,o=0){return Ft(t,e,!0,o)}function ri(t,e){return pe(t,Gt(t/2,e,e/2))}function ai(t,e){const o=e,i=e/2,r=t/2,a=.8*o,c=Bt(r,(t-e)/2-a,Math.sqrt(a*a+i*i)),s=Gt(r,o,i);return pe(t,(n,l)=>Math.max(s(n,l),-c(n,l)))}function Ht(t,e,o){return o&&(e/=Math.SQRT2),pe(t,(i,r)=>{let a=i-.5*t+.25,c=.5*t-r-.75;if(o){const s=(a+c)/Math.SQRT2;c=(c-a)/Math.SQRT2,a=s}return Math.max(Math.abs(a),Math.abs(c))-.5*e})}function Ft(t,e,o,i=0){e-=i,o&&(e*=Math.SQRT2);const r=.5*e;return pe(t,(a,c)=>{let s,n=a-.5*t,l=.5*t-c-1;if(o){const u=(n+l)/Math.SQRT2;l=(l-n)/Math.SQRT2,n=u}return n=Math.abs(n),l=Math.abs(l),s=n>l?n>r?Math.sqrt((n-r)*(n-r)+l*l):l:l>r?Math.sqrt(n*n+(l-r)*(l-r)):n,s-=i/2,s})}function Bt(t,e,o){return(i,r)=>{const a=i-t,c=r-e;return Math.sqrt(a*a+c*c)-o}}function Gt(t,e,o){const i=Math.sqrt(e*e+o*o);return(r,a)=>{const c=Math.abs(r-t)-o,s=a-t+e/2+.75,n=(e*c+o*s)/i,l=-s;return Math.max(n,l)}}function pe(t,e){const o=new Uint8Array(4*t*t);for(let i=0;i<t;i++)for(let r=0;r<t;r++){const a=r+t*i;let c=e(r,i);c=c/t+.5,Lo(c,o,4*a)}return o}function si(t){return t instanceof Float32Array&&t.length>=16}function ni(t){return Array.isArray(t)&&t.length>=16}function li(t){return si(t)||ni(t)}function Ze(t){t.uniforms.add(new mo("alignPixelEnabled",(e,o)=>o.alignPixelEnabled)),t.code.add(d`vec4 alignToPixelCenter(vec4 clipCoord, vec2 widthHeight) {
