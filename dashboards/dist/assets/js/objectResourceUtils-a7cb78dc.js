...
return transformWorldFromViewTL + vPositionWorldCameraRelative;
}`)}let Ps=class extends Ct{constructor(){super(...arguments),this.transformWorldFromViewTH=P(),this.transformWorldFromViewTL=P(),this.transformViewFromCameraRelativeRS=Zt(),this.transformProjFromView=Kt()}};function la(t,e){switch(e.normalType){case H.Attribute:case H.Compressed:t.include(er,e),t.varyings.add("vNormalWorld","vec3"),t.varyings.add("vNormalView","vec3"),t.vertex.uniforms.add(new na("transformNormalGlobalFromModel",r=>r.transformNormalGlobalFromModel),new Me("transformNormalViewFromGlobal",r=>r.transformNormalViewFromGlobal)),t.vertex.code.add(s`void forwardNormal() {
...
}`))}var ce;(function(t){t[t.RED=0]="RED",t[t.RG=1]="RG",t[t.RGBA4=2]="RGBA4",t[t.RGBA=3]="RGBA",t[t.RGBA_MIPMAP=4]="RGBA_MIPMAP",t[t.R16F=5]="R16F",t[t.RGBA16F=6]="RGBA16F"})(ce||(ce={}));const Pt=new be;Pt.pixelFormat=he.RED,Pt.internalFormat=St.R8,Pt.wrapMode=ie.CLAMP_TO_EDGE;const Nt=new be;Nt.pixelFormat=he.RG,Nt.internalFormat=St.RG8,Nt.wrapMode=ie.CLAMP_TO_EDGE;const Dt=new be;Dt.internalFormat=St.RGBA4,Dt.dataType=Jt.UNSIGNED_SHORT_4_4_4_4,Dt.wrapMode=ie.CLAMP_TO_EDGE;const wa=new be;wa.wrapMode=ie.CLAMP_TO_EDGE;const ut=new be;ut.wrapMode=ie.CLAMP_TO_EDGE,ut.samplingMode=_e.LINEAR_MIPMAP_LINEAR,ut.hasMipmap=!0,ut.maxAnisotropy=8;const ht=new be;ht.pixelFormat=he.RED,ht.dataType=Jt.HALF_FLOAT,ht.internalFormat=St.R16F,ht.samplingMode=_e.NEAREST;const Ft=new be;Ft.dataType=Jt.HALF_FLOAT,Ft.internalFormat=St.RGBA16F,Ft.samplingMode=_e.NEAREST;ce.RED+"",ce.RG+"",ce.RGBA4+"",ce.RGBA+"",ce.RGBA_MIPMAP+"",ce.R16F+"",ce.RGBA16F+"";var qe;(function(t){t[t.DEPTH_STENCIL_TEXTURE=0]="DEPTH_STENCIL_TEXTURE",t[t.DEPTH_STENCIL_BUFFER=1]="DEPTH_STENCIL_BUFFER",t[t.DEPTH24_BUFFER=2]="DEPTH24_BUFFER",t[t.DEPTH16_BUFFER=3]="DEPTH16_BUFFER"})(qe||(qe={}));const mt=new be;mt.pixelFormat=he.DEPTH_STENCIL,mt.dataType=Jt.UNSIGNED_INT_24_8,mt.samplingMode=_e.NEAREST,mt.wrapMode=ie.CLAMP_TO_EDGE;qe.DEPTH_STENCIL_TEXTURE+"",qe.DEPTH_STENCIL_BUFFER+"",new cr(sr.DEPTH24_STENCIL8,4),qe.DEPTH24_BUFFER+"",new cr(sr.DEPTH_COMPONENT24,4),qe.DEPTH16_BUFFER+"",new cr(sr.DEPTH_COMPONENT16,4);const Aa={required:[]};x.Depth;x.CompositeColor;x.Highlight;const ml={required:[x.Depth,x.Normal]};let pl=class extends Lo{consumes(){return Aa}get usedMemory(){return 0}get isDecoration(){return!1}get running(){return!1}},fl=class extends pl{};function Ma(t,e=!0){t.attributes.add(p.POSITION,"vec2"),e&&t.varyings.add("uv","vec2"),t.vertex.code.add(s`
    void main(void) {
