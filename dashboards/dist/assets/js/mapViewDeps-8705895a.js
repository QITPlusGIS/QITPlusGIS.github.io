import{gr as Ie,nX as ae,eV as $e,hd as Ue,R as q,nY as ke,nZ as Le,n_ as Ne,jt as He,n$ as qe,o0 as Ge,o1 as B,eZ as x,e_ as v,e$ as H,f7 as J,an as Ve,de as Pe,F as Ce,fr as We,o2 as je,o3 as Ke,aE as K,eY as ee,f8 as W,lt as Y,fw as X,lr as Ye,f5 as oe,f6 as Xe,f3 as Qe,kN as Ze,kP as Je,j4 as et,kZ as tt,k_ as it,L as D,o4 as N,i3 as le,f0 as de,iu as rt,I as E,i2 as te,o5 as Se,j5 as ue,H as T,U as ie,fe as he,h_ as st,l9 as nt,o6 as at,o7 as ot,s as lt,lc as ce,G as dt,o8 as ut,$ as _e,ld as ht,D as ct,eS as _t,x as Q,P as ft,as as fe,cC as mt,a2 as me,o9 as pt}from"./index-709d080c.js";import{c as gt}from"./ExpandedCIM-ef671ba0.js";import{p as vt,s as bt}from"./imageUtils-918ea0ae.js";import{t as xt,b as wt,o as pe,h as yt,i as Tt}from"./Container-a559bf1c.js";import{i as Ft}from"./BufferPool-4fcc93dd.js";import{T as M,E as S,S as U}from"./color-906689d6.js";import{g as Bt,a as L,h as G,w as A,d as Et,m as Ot}from"./WGLContainer-1a8b1ee3.js";import{e as Rt,a as j,f as re}from"./ProgramTemplate-1082d575.js";import{n as $}from"./programUtils-80aaf86e.js";import{e as ge,r as Mt,t as Pt,a as Ct,m as St,J as At,n as Dt,b as zt,c as It}from"./MagnifierPrograms-3735b5a4.js";import{d as qr,y as Gr}from"./MagnifierPrograms-3735b5a4.js";import{h as se,E as C,a as ne,i as $t}from"./FramebufferObject-3b96e2fc.js";import{o as ve,N as Ut}from"./RenderingContext-5b79036f.js";import{e as O,T as k}from"./Texture-10a5939e.js";import{r as Wr}from"./GraphicsView2D-94092b25.js";import{i as Kr}from"./GraphicContainer-6345e8d8.js";import{t as be}from"./requestImageUtils-65b74219.js";import"./BidiEngine-9a40f2f4.js";import"./visualVariablesUtils-3c4fa38c.js";import"./GeometryUtils-58fd4c09.js";import"./Rect-ea14f53a.js";import"./quantizationUtils-0cd11aba.js";import"./floatRGBA-028de362.js";import"./AttributeStoreView-e38d3215.js";import"./TiledDisplayObject-ae6319e7.js";import"./util-de83a503.js";import"./config-1337d16e.js";import"./earcut-542fe939.js";import"./NestedMap-1b5db22e.js";import"./rasterizingUtils-7585f933.js";import"./imageutils-8f82f3c0.js";import"./Matcher-b851c754.js";import"./tileUtils-c2f19f52.js";import"./TurboLine-845960ce.js";import"./CircularArray-ef508845.js";import"./testSVGPremultipliedAlpha-2956a66d.js";import"./throttle-7bf02de9.js";import"./ComputedAttributeStorage-b467c3de.js";import"./TimeOnly-94cbed0e.js";import"./OrderIndependentTransparency-35895022.js";import"./basicInterfaces-11f56cb3.js";import"./doublePrecisionUtils-e3c3d0d8.js";import"./normalizeUtilsSync-6a6170eb.js";import"./projectionSupport-1063052c.js";import"./json-48e3ea08.js";import"./BaseGraphicContainer-dc6c6339.js";import"./FeatureContainer-6bd1f2a0.js";import"./TileContainer-c80bebf8.js";import"./vec3f32-2da9db36.js";let kt=class{constructor(){this._resourceMap=new Map,this._inFlightResourceMap=new Map,this.geometryEngine=null,this.geometryEnginePromise=null}destroy(){this._inFlightResourceMap.clear(),this._resourceMap.clear()}getResource(e){return this._resourceMap.get(e)??null}async fetchResource(e,t){const i=this._resourceMap.get(e);if(i)return{width:i.width,height:i.height};let r=this._inFlightResourceMap.get(e);return r?r.then(n=>({width:n.width,height:n.height})):(r=vt(e,t),this._inFlightResourceMap.set(e,r),r.then(n=>(this._inFlightResourceMap.delete(e),this._resourceMap.set(e,n),{width:n.width,height:n.height}),()=>({width:0,height:0})))}deleteResource(e){this._inFlightResourceMap.delete(e),this._resourceMap.delete(e)}loadFont(e){return gt(e)}},Lt=class{constructor(e){this.events=new Ie,this._hasMajorPerformanceCaveat=!1,this._lastRenderFrameCounter=0,this._canvas=document.createElement("canvas"),this._canvas.setAttribute("style","width: 100%; height:100%; display:block; willChange:transform");const t={failIfMajorPerformanceCaveat:!0,alpha:!0,antialias:!1,depth:!0,stencil:!0};e.appendChild(this._canvas);let i=ae("2d",this._canvas,t);i||(i=ae("2d",this._canvas,{...t,failIfMajorPerformanceCaveat:!1}),this._hasMajorPerformanceCaveat=!0),this._gl=i,this._handles=$e([Ue(this._canvas,"webglcontextlost",r=>this.events.emit("webgl-context-lost",r))])}destroy(){var e;(e=this._canvas.parentNode)==null||e.removeChild(this._canvas),this._canvas=null,this._handles.remove(),this._gl=null}get gl(){return this._gl}render(e,t){if(this._hasMajorPerformanceCaveat||q("esri-force-performance-mode")){if(++this._lastRenderFrameCounter>=q("esri-performance-mode-frames-between-render")&&(t(),this._lastRenderViewState=e.state.clone(),this._lastRenderFrameCounter=0),this._lastRenderViewState){const[i,r,n,s,a,o]=this._computeViewTransform(this._lastRenderViewState,e.state);this._canvas.style.transform=`matrix(${i}, ${r}, ${n}, ${s}, ${a}, ${o})`}}else t()}resize(e){const t=this._canvas,i=t.style,{state:{size:r},pixelRatio:n}=e,s=r[0],a=r[1],o=Math.round(s*n),d=Math.round(a*n);t.width===o&&t.height===d||(t.width=o,t.height=d),i.width=s+"px",i.height=a+"px"}_computeViewTransform(e,t){const[i,r]=e.center,[n,s]=t.center,[a,o]=e.toScreen([0,0],n,s),[d,u]=e.toScreen([0,0],i,r),h=d-a,_=u-o,m=e.scale/t.scale,g=t.rotation-e.rotation,f=Ge();return ke(f),Le(f,f,[m,m]),Ne(f,f,He(g)),qe(f,f,[h,_]),f}};const Nt={background:{"background.frag":`#ifdef PATTERN
