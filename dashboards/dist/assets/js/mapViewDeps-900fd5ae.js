import{f$ as Ie,mE as ae,eB as ke,gN as Ue,R as q,mF as $e,mG as Le,mH as Ne,iJ as He,mI as qe,mJ as Ge,mK as B,eF as x,eG as v,eH as H,eP as Z,ao as Ve,c_ as Pe,F as Ce,f0 as We,mL as je,mM as Ke,aK as K,eE as ee,eQ as W,kI as Y,f6 as X,kH as Ye,eN as oe,eO as Xe,eL as Qe,k3 as Je,k5 as Ze,iy as et,kf as tt,kg as it,L as D,mN as N,hF as le,eI as de,i1 as rt,I as E,hE as te,mO as Se,iz as ue,H as T,U as ie,eW as he,hA as st,kr as nt,mP as at,mQ as ot,s as lt,ku as ce,G as dt,mR as ut,a0 as _e,kv as ht,D as ct,ey as _t,x as Q,P as ft,aw as fe,cH as mt,a3 as me,mS as pt}from"./index-7211d811.js";import{c as gt}from"./ExpandedCIM-8f4619ac.js";import{p as vt,s as bt}from"./imageUtils-ae84c990.js";import{t as xt,b as wt,o as pe,h as yt,i as Tt}from"./Container-d43c5e18.js";import{i as Ft}from"./BufferPool-5b15b515.js";import{T as M,E as S,S as U}from"./color-59c4e3eb.js";import{g as Bt,a as L,h as G,w as A,d as Et,m as Ot}from"./WGLContainer-a1237a72.js";import{e as Rt,a as j,f as re}from"./ProgramTemplate-d525368d.js";import{n as k}from"./programUtils-4e3d3165.js";import{e as ge,r as Mt,t as Pt,a as Ct,m as St,J as At,n as Dt,b as zt,c as It}from"./MagnifierPrograms-20917c6e.js";import{d as Kr,y as Yr}from"./MagnifierPrograms-20917c6e.js";import{h as se,E as C,a as ne,i as kt}from"./FramebufferObject-8e2c7ff7.js";import{o as ve,N as Ut}from"./RenderingContext-b6c3b2ed.js";import{e as O,T as $}from"./Texture-8977e2c7.js";import{r as Qr}from"./GraphicsView2D-e56403cb.js";import{i as Zr}from"./GraphicContainer-44e1156d.js";import{t as be}from"./requestImageUtils-888baadb.js";import"./BidiEngine-9a40f2f4.js";import"./visualVariablesUtils-60e1228c.js";import"./OptimizedGeometry-d94e541f.js";import"./utils-859f11ff.js";import"./GeometryUtils-40aada46.js";import"./Rect-ea14f53a.js";import"./quantizationUtils-d7291828.js";import"./floatRGBA-d7257b49.js";import"./AttributeStoreView-c1b5df35.js";import"./TiledDisplayObject-e3310e87.js";import"./util-66772d31.js";import"./config-1337d16e.js";import"./earcut-fa517ba8.js";import"./featureConversionUtils-7dacf99d.js";import"./OptimizedFeatureSet-1d1ac4b9.js";import"./NestedMap-1b5db22e.js";import"./rasterizingUtils-285e9663.js";import"./pbf-e184c7c2.js";import"./imageutils-7aa9c334.js";import"./Matcher-3eec7674.js";import"./tileUtils-c2f19f52.js";import"./TurboLine-6a95ed40.js";import"./CircularArray-ef508845.js";import"./testSVGPremultipliedAlpha-14ef1759.js";import"./throttle-7bf02de9.js";import"./ComputedAttributeStorage-dbd00f5a.js";import"./TimeOnly-52b98de5.js";import"./OrderIndependentTransparency-a563a33e.js";import"./basicInterfaces-11f56cb3.js";import"./doublePrecisionUtils-e3c3d0d8.js";import"./normalizeUtilsSync-54a1e768.js";import"./projectionSupport-26da4a4e.js";import"./json-48e3ea08.js";import"./BaseGraphicContainer-dd4c9642.js";import"./FeatureContainer-a119acd6.js";import"./TileContainer-4b2862fb.js";import"./vec3f32-2da9db36.js";let $t=class{constructor(){this._resourceMap=new Map,this._inFlightResourceMap=new Map,this.geometryEngine=null,this.geometryEnginePromise=null}destroy(){this._inFlightResourceMap.clear(),this._resourceMap.clear()}getResource(e){return this._resourceMap.get(e)??null}async fetchResource(e,t){const i=this._resourceMap.get(e);if(i)return{width:i.width,height:i.height};let r=this._inFlightResourceMap.get(e);return r?r.then(n=>({width:n.width,height:n.height})):(r=vt(e,t),this._inFlightResourceMap.set(e,r),r.then(n=>(this._inFlightResourceMap.delete(e),this._resourceMap.set(e,n),{width:n.width,height:n.height}),()=>({width:0,height:0})))}deleteResource(e){this._inFlightResourceMap.delete(e),this._resourceMap.delete(e)}loadFont(e){return gt(e)}},Lt=class{constructor(e){this.events=new Ie,this._hasMajorPerformanceCaveat=!1,this._lastRenderFrameCounter=0,this._canvas=document.createElement("canvas"),this._canvas.setAttribute("style","width: 100%; height:100%; display:block; willChange:transform");const t={failIfMajorPerformanceCaveat:!0,alpha:!0,antialias:!1,depth:!0,stencil:!0};e.appendChild(this._canvas);let i=ae("2d",this._canvas,t);i||(i=ae("2d",this._canvas,{...t,failIfMajorPerformanceCaveat:!1}),this._hasMajorPerformanceCaveat=!0),this._gl=i,this._handles=ke([Ue(this._canvas,"webglcontextlost",r=>this.events.emit("webgl-context-lost",r))])}destroy(){var e;(e=this._canvas.parentNode)==null||e.removeChild(this._canvas),this._canvas=null,this._handles.remove(),this._gl=null}get gl(){return this._gl}render(e,t){if(this._hasMajorPerformanceCaveat||q("esri-force-performance-mode")){if(++this._lastRenderFrameCounter>=q("esri-performance-mode-frames-between-render")&&(t(),this._lastRenderViewState=e.state.clone(),this._lastRenderFrameCounter=0),this._lastRenderViewState){const[i,r,n,s,a,o]=this._computeViewTransform(this._lastRenderViewState,e.state);this._canvas.style.transform=`matrix(${i}, ${r}, ${n}, ${s}, ${a}, ${o})`}}else t()}resize(e){const t=this._canvas,i=t.style,{state:{size:r},pixelRatio:n}=e,s=r[0],a=r[1],o=Math.round(s*n),d=Math.round(a*n);t.width===o&&t.height===d||(t.width=o,t.height=d),i.width=s+"px",i.height=a+"px"}_computeViewTransform(e,t){const[i,r]=e.center,[n,s]=t.center,[a,o]=e.toScreen([0,0],n,s),[d,u]=e.toScreen([0,0],i,r),h=d-a,_=u-o,m=e.scale/t.scale,g=t.rotation-e.rotation,f=Ge();return $e(f),Le(f,f,[m,m]),Ne(f,f,He(g)),qe(f,f,[h,_]),f}};const Nt={background:{"background.frag":`#ifdef PATTERN
