import{n as e}from"./glsl-DR5qAdui.js";import{t}from"./ShaderBuilder-DZEqsQYk.js";import{M as n,W as r,kt as i,n as a,pn as o,t as s}from"./VertexColor.glsl-ewiTSNA6.js";function c(c){let l=new t,{vertex:u,fragment:d,varyings:f}=l;return l.fragment.include(i,c),l.include(a),l.include(s,c),l.include(n,c),r(u,c),l.attributes.add(`position`,`vec3`),f.add(`vpos`,`vec3`,{invariant:!0}),u.main.add(e`vpos = position;
forwardVertexColor();
